...
Repo Link: https://github.com/apathi2004/Evil-Wordle.git
...
m partitions remaining word possibilities
...
### Key Features
Multiple selectable difficulty levels
Interactive GUI with settings and stats menus
Adjustable music and sound effect controls
Persistent gameplay statistics tracking
Real-time combat and weapon interaction system
Pause menu with resume and quit functionality
Keyboard and mouse-based player controls
Frame capture functionality for gameplay snapshots
